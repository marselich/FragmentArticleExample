package ru.kalievmars.fragmentarticleexample.fragments;
...
import ru.kalievmars.fragmentarticleexample.R;
...
public class RaitingBarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_raiting_bar, container, false);
    ...
    private void addListenerOnButton(RatingBar ratingBar) {
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                Toast.makeText(getActivity(), "Ваша оценка: " + rating, Toast.LENGTH_SHORT).show();
            }
        });
    }
}